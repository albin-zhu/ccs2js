#{it.defineType + it.Name} = new ccui.Slider();
// attr
...
<?js 
        var textureList = [
            {name: "BackGroundData", handle: "loadBarTexture"},
            {name: "BallNormalData", handle: "loadSlidBallTextureNormal"},
            {name: "BallPressedData", handle: "loadSlidBallTexturePressed"},
            {name: "BallDisabledData", handle: "loadSlidBallTextureDisabled"},
            {name: "ProgressBarData", handle: "loadProgressBarTexture"}
        ];
...
<?js }); ?>
<?js 
        var percent = it["PercentInfo"] || 0; ?>
#{it.Name}.setPercent(${percent});
<?js 
